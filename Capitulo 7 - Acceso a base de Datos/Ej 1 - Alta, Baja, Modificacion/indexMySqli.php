...
<html>
    ...
    <body>
        ...
        <table>
            ...
            <tr>
                <form action="indexMySqli.php" method="post">
    ...
    <?php 
        ...
        function listado ($sentencia) {
            ...
            while ($registro = $sentencia->fetch_object()) {

                // Boton borrado, en HTML
                $botonBorrado = '<form action="indexMySqli.php" method="post">'
                  . '<input type="hidden" name="dni" value="' . $registro->dni . '">'
                  . '<input type="submit" name="borrar" value="Borrar"></form>';

                // Boton modificar, en HTML
                $botonModificar = '<form action="indexMySqli.php" method="post">'
                  . '<input type="hidden" name="dni" value="' . $registro->dni . '">'
                ...
                if (isset($_POST['modificar']) && $registro->dni == $_POST['dni']) {
                    ...
                    echo '<tr><form action="indexMySqli.php" method="post">';
